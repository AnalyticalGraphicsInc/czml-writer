...
public class TestGregorianDateParsing {
    ...
    public final void testTryParseISO8601DayOfYear() {
        ...
        final boolean temp$0 = GregorianDate.tryParse("1985-042T02:00:05.2134", out$result$1);
        ...
        final boolean temp$2 = GregorianDate.tryParse("1985-042T02:00:05.21345Z", out$result$3);
        ...
        final boolean temp$4 = GregorianDate.tryParse("1985-042T02:00:05", out$result$5);
        ...
        AssertHelper.assertEquals(iso, result);
        iso = new GregorianDate(1985, 2, 11);
        final GregorianDate[] out$result$7 = {
            null
        };
        final boolean temp$6 = GregorianDate.tryParse("1985-042", out$result$7);
        result = out$result$7[0];
        if (!temp$6) {
            Assert.fail();
        }
        AssertHelper.assertEquals(iso, result);
        ...
        Assert.assertFalse(GregorianDate.tryParse("1985-367T02:00:05.2134", out$result$8));
        result = out$result$8[0];
        final GregorianDate[] out$result$9 = {
            null
        };
        Assert.assertFalse(GregorianDate.tryParse("1985-12#T02:00:05.2134", out$result$9));
        result = out$result$9[0];
        final GregorianDate[] out$result$10 = {
            null
        };
        Assert.assertFalse(GregorianDate.tryParse("21985-167T02:00:05.2134", out$result$10));
    ...
    public final void testParse() {
        ...
        final GregorianDate[] out$unusedDate$11 = {
            null
        };
        GregorianDate.tryParse("06/30/2009 05:25:00.1234567890123456", out$unusedDate$11);
        unusedDate = out$unusedDate$11[0];
    ...
    public final void testTryParse() {
        ...
        Assert.assertEquals(true, GregorianDate.tryParse("02/25/2002", m_cultureInfo, out$result$12));
        result = out$result$12[0];
        AssertHelper.assertEquals(expected, result);
        final GregorianDate[] out$result$13 = {
            null
        };
        Assert.assertEquals(false, GregorianDate.tryParse("02/q/2002", m_cultureInfo, out$result$13));
        result = out$result$13[0];
        AssertHelper.assertEquals(GregorianDate.MinValue, result);
        final GregorianDate[] out$result$14 = {
            null
        };
        Assert.assertEquals(false, GregorianDate.tryParse(null, m_cultureInfo, out$result$14));
        result = out$result$14[0];
        AssertHelper.assertEquals(GregorianDate.MinValue, result);
    }
    ...
    public final void cannotParseInvalidDates() {
        @CS2JInfo("Initialization of C# struct variable 'result' added by translator.")
        GregorianDate result = new GregorianDate();
        final GregorianDate[] out$result$15 = {
            null
        };
        Assert.assertEquals(false, GregorianDate.tryParse("02/29/2002", m_cultureInfo, out$result$15));
        result = out$result$15[0];
        AssertHelper.assertEquals(GregorianDate.MinValue, result);
        final GregorianDate[] out$result$16 = {
            null
        };
        Assert.assertEquals(false, GregorianDate.tryParse("13/01/2002", m_cultureInfo, out$result$16));
