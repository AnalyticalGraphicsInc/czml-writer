									...
									try {
										...
										}
										{
											...
											try {
												...
												tempCollection_0.add(startDate);
												tempCollection_0.add(stopDate);
												ArrayList<cesiumlanguagewriter.JulianDate> dates = tempCollection_0;
												ArrayList<cesiumlanguagewriter.Cartesian> tempCollection_1 = new ArrayList<cesiumlanguagewriter.Cartesian>();
												tempCollection_1.add(new Cartesian(1.0, 2.0, 3.0));
												tempCollection_1.add(new Cartesian(10.0, 12.0, 14.0));
												ArrayList<cesiumlanguagewriter.Cartesian> values = tempCollection_1;
