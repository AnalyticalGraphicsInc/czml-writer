...
public class TestCesiumFormattingHelper {
    ...
    public final void testPathModeToString(@Nonnull CesiumPathMode value) {
        String s = CesiumFormattingHelper.pathModeToString(value);
        Assert.assertNotNull(s);
    }

    @Test
    public final void testPathModeToString$Test() {
        for (final CesiumPathMode value : EnumHelper.getValues(CesiumPathMode.class)) {
            testPathModeToString(value);
        }
    }
