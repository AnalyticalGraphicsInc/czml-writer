...
public class LineCountCesiumWriter extends CesiumInterpolatablePropertyWriter<LineCountCesiumWriter> {
    ...
    */
    ...
    private final ICesiumInterpolatableValuePropertyWriter<Rectangular> createCartesian2Adaptor() {
        return new CesiumInterpolatableWriterAdaptor<cesiumlanguagewriter.LineCountCesiumWriter, cesiumlanguagewriter.Rectangular>(this,
                new CesiumWriterAdaptorWriteCallback<cesiumlanguagewriter.LineCountCesiumWriter, cesiumlanguagewriter.Rectangular>() {
                    public void invoke(LineCountCesiumWriter me, Rectangular value) {
                        me.writeCartesian2(value);
                    }
                }, new CesiumWriterAdaptorWriteSamplesCallback<cesiumlanguagewriter.LineCountCesiumWriter, cesiumlanguagewriter.Rectangular>() {
                    public void invoke(LineCountCesiumWriter me, List<JulianDate> dates, List<Rectangular> values, int startIndex, int length) {
    ...
    */
    ...
    private final ICesiumValuePropertyWriter<Reference> createReferenceAdaptor() {
        return new CesiumWriterAdaptor<cesiumlanguagewriter.LineCountCesiumWriter, cesiumlanguagewriter.Reference>(this,
                new CesiumWriterAdaptorWriteCallback<cesiumlanguagewriter.LineCountCesiumWriter, cesiumlanguagewriter.Reference>() {
                    public void invoke(LineCountCesiumWriter me, Reference value) {
