...
public class BillboardCesiumWriter extends CesiumPropertyWriter<BillboardCesiumWriter> {
    ...
    */
    ...
    @Nonnull
    private final Lazy<AlignedAxisCesiumWriter> m_alignedAxis = new Lazy<AlignedAxisCesiumWriter>(Func1.<AlignedAxisCesiumWriter> of(() -> {
        return new AlignedAxisCesiumWriter(AlignedAxisPropertyName);
    }), false);
    @Nonnull
    private final Lazy<BooleanCesiumWriter> m_sizeInMeters = new Lazy<BooleanCesiumWriter>(Func1.<BooleanCesiumWriter> of(() -> {
    ...
    @Nonnull
    private final Lazy<BoundingRectangleCesiumWriter> m_imageSubRegion = new Lazy<BoundingRectangleCesiumWriter>(Func1.<BoundingRectangleCesiumWriter> of(() -> {
