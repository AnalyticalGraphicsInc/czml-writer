...
public class RepeatCesiumWriter extends CesiumInterpolatablePropertyWriter<RepeatCesiumWriter>
    ...
    */
    ...
    @Nonnull
    private final Lazy<CesiumCartesian2ValuePropertyAdaptor<RepeatCesiumWriter>> m_asCartesian2;
    @Nonnull
    private final Lazy<CesiumReferenceValuePropertyAdaptor<RepeatCesiumWriter>> m_asReference;
    ...
    */
    ...
    /**
    * Writes the value expressed as a {@code cartesian2}, which is the number of times the image repeats along each axis.
    ...
    */
    ...
    /**
    * Writes the value expressed as a {@code reference}, which is the number of times the image repeats specified as a reference to another property.
    ...
    */
    @Nonnull
    public final CesiumCartesian2ValuePropertyAdaptor<RepeatCesiumWriter> asCartesian2() {
    ...
    private final Lazy<CesiumCartesian2ValuePropertyAdaptor<RepeatCesiumWriter>> createAsCartesian2() {
        return new Lazy<CesiumCartesian2ValuePropertyAdaptor<RepeatCesiumWriter>>(Func1.<CesiumCartesian2ValuePropertyAdaptor<RepeatCesiumWriter>> of(this::createCartesian2, this, "createCartesian2"),
                false);
    }

    @Nonnull
    private final CesiumCartesian2ValuePropertyAdaptor<RepeatCesiumWriter> createCartesian2() {
        return CesiumValuePropertyAdaptors.<RepeatCesiumWriter> createCartesian2(this);
    }
    ...
    */
    @Nonnull
    public final CesiumReferenceValuePropertyAdaptor<RepeatCesiumWriter> asReference() {
        return m_asReference.getValue();
    }

    @Nonnull
    private final Lazy<CesiumReferenceValuePropertyAdaptor<RepeatCesiumWriter>> createAsReference() {
        return new Lazy<CesiumReferenceValuePropertyAdaptor<RepeatCesiumWriter>>(Func1.<CesiumReferenceValuePropertyAdaptor<RepeatCesiumWriter>> of(this::createReference, this, "createReference"),
                false);
    }

    @Nonnull
    private final CesiumReferenceValuePropertyAdaptor<RepeatCesiumWriter> createReference() {
        return CesiumValuePropertyAdaptors.<RepeatCesiumWriter> createReference(this);
    }
}