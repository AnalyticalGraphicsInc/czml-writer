...
public class NodeTransformationsCesiumWriter extends CesiumPropertyWriter<NodeTransformationsCesiumWriter> {
	...
	/**
	 *  
	Gets a new writer for a <code>NodeTransformation</code> property.  The returned instance must be opened by calling the  {@link CesiumElementWriter#open} method before it can be used for writing.  A <code>NodeTransformation</code> property defines transformations to apply to a particular node in a 3D model.
