...
public class PathCesiumWriter extends CesiumPropertyWriter<PathCesiumWriter> {
    ...
    */
    ...
    /**
    * Gets the writer for the {@code materialMode} property. The returned instance must be opened by calling the {@link CesiumElementWriter#open} method before it can be used for writing. The {@code materialMode} property defines whether the material applies to the whole path or portions of the path. If not specified, the default value is WHOLE.
    */
    @Nonnull
    ...
    /**
    * Opens and returns the writer for the {@code materialMode} property. The {@code materialMode} property defines whether the material applies to the whole path or portions of the path. If not specified, the default value is WHOLE.
    */
    @Nonnull
    ...
    /**
    * Writes a value for the {@code materialMode} property as a {@code pathMode} value. The {@code materialMode} property specifies whether the material applies to the whole path or portions of the path. If not specified, the default value is WHOLE.
    ...
    */
    ...
    /**
    * Writes a value for the {@code materialMode} property as a {@code reference} value. The {@code materialMode} property specifies whether the material applies to the whole path or portions of the path. If not specified, the default value is WHOLE.
    * @param value The reference.
    */
