...
/**
 *  
 Writes a <code>Clock</code> to a  {@link CesiumOutputStream}.  A <code>Clock</code> is initial settings for a simulated clock when a document is loaded.  The start and stop time are configured using the interval property.
