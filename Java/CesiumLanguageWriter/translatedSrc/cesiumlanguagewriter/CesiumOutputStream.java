...
public class CesiumOutputStream {
	...
	/**
	 *  
	When <code>PrettyFormatting</code> ({@link #getPrettyFormatting get} / {@link #setPrettyFormatting set}) is <see langword="true" />, adds a line break in a sequence of simple values.
	When <code>PrettyFormatting</code> ({@link #getPrettyFormatting get} / {@link #setPrettyFormatting set}) is <see langword="false" />, this method does nothing.
	...
	static private void writeEscapedString(Writer writer, String value) {
	...
	static private String toCharAsUnicode(char c) {
	...
	static private char intToHex(int n) {
		if (n <= 9) {
			return (char) (n + 48);
		}
		return (char) ((n - 10) + 97);
	...
	final private void startNewValue() {
	...
	final private void writeIndent() {
