...
public class CylinderCesiumWriter extends CesiumPropertyWriter<CylinderCesiumWriter> {
	...
	/**
	 *  Gets the writer for the <code>shadows</code> property.  The returned instance must be opened by calling the  {@link CesiumElementWriter#open} method before it can be used for writing.  The <code>shadows</code> property defines whether or not the cylinder casts or receives shadows.  If not specified, the default value is DISABLED.
