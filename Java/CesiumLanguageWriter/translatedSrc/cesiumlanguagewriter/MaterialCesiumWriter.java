...
public class MaterialCesiumWriter extends CesiumPropertyWriter<MaterialCesiumWriter> {
	...
	/**
	 *  Gets the writer for the <code>polylineOutline</code> property.  The returned instance must be opened by calling the  {@link CesiumElementWriter#open} method before it can be used for writing.  The <code>polylineOutline</code> property defines fills the surface of a line with an outlined color.
	...
	/**
	 *  Gets the writer for the <code>polylineGlow</code> property.  The returned instance must be opened by calling the  {@link CesiumElementWriter#open} method before it can be used for writing.  The <code>polylineGlow</code> property defines fills the surface of a line with a glowing color.
