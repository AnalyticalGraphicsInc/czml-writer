...
public class RectangleCesiumWriter extends CesiumPropertyWriter<RectangleCesiumWriter> {
    ...
    */
    ...
    @Nonnull
    private final Lazy<RectangleCoordinatesCesiumWriter> m_coordinates = new Lazy<cesiumlanguagewriter.RectangleCoordinatesCesiumWriter>(
            new Func1<cesiumlanguagewriter.RectangleCoordinatesCesiumWriter>() {
