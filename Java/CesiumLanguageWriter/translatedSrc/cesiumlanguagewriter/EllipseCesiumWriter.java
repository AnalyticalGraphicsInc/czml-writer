...
public class EllipseCesiumWriter extends CesiumPropertyWriter<EllipseCesiumWriter> {
    ...
    */
    ...
    @Nonnull
    private final Lazy<DoubleCesiumWriter> m_semiMajorAxis = new Lazy<DoubleCesiumWriter>(Func1.<DoubleCesiumWriter> of(() -> {
        return new DoubleCesiumWriter(SemiMajorAxisPropertyName);
    }), false);
    @Nonnull
    private final Lazy<DoubleCesiumWriter> m_semiMinorAxis = new Lazy<DoubleCesiumWriter>(Func1.<DoubleCesiumWriter> of(() -> {
    ...
    @Nonnull
    private final Lazy<DoubleCesiumWriter> m_rotation = new Lazy<DoubleCesiumWriter>(Func1.<DoubleCesiumWriter> of(() -> {
