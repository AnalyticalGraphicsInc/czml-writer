...
public class RectangularSensorCesiumWriter extends CesiumPropertyWriter<RectangularSensorCesiumWriter> {
    ...
    */
    ...
    @Nonnull
    private final Lazy<DoubleCesiumWriter> m_xHalfAngle = new Lazy<DoubleCesiumWriter>(Func1.<DoubleCesiumWriter> of(() -> {
        return new DoubleCesiumWriter(XHalfAnglePropertyName);
    }), false);
    @Nonnull
    private final Lazy<DoubleCesiumWriter> m_yHalfAngle = new Lazy<DoubleCesiumWriter>(Func1.<DoubleCesiumWriter> of(() -> {
