...
/**
 *  
 Writes a <code>NearFarScalar</code> to a  {@link CesiumOutputStream}.  A <code>NearFarScalar</code> is a numeric value which will be linearly interpolated between two values based on an object's distance from the camera, in eye coordinates.  The computed value will interpolate between the near value and the far value while the camera distance falls between the near distance and the far distance, and will be clamped to the near or far value while the distance is less than the near distance or greater than the far distance, respectively.
...
public class NearFarScalarCesiumWriter extends CesiumInterpolatablePropertyWriter<NearFarScalarCesiumWriter> {
	/**
	 *  
	The name of the <code>nearFarScalar</code> property.
	...
	public final void writeNearFarScalar(NearFarScalar value) {
		String PropertyName = NearFarScalarPropertyName;
	...
	/**
	 *  
	Writes the value expressed as a <code>reference</code>, which is the value specified as a reference to another property.
	...
	/**
	 *  
	Returns a wrapper for this instance that implements  {@link ICesiumInterpolatableValuePropertyWriter} to write a value in <code>NearFarScalar</code> format.  Because the returned instance is a wrapper for this instance, you may call  {@link ICesiumElementWriter#close} on either this instance or the wrapper, but you must not call it on both.
	...
	final private ICesiumInterpolatableValuePropertyWriter<NearFarScalar> createNearFarScalarAdaptor() {
