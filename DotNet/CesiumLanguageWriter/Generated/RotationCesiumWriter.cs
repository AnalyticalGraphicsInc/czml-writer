...
{
    /// <summary>
    /// Writes a <code>Rotation</code> to a <see cref="CesiumOutputStream" />.  A <code>Rotation</code> is defines a rotation that transforms a vector expressed in one axes and transforms it to another.
    /// </summary>
