...
{
    /// <summary>
    /// Writes a <code>HeightReference</code> to a <see cref="CesiumOutputStream" />.  A <code>HeightReference</code> is the height reference of an object, which indicates if the object's position is relative to terrain or not.
    /// </summary>
    public class HeightReferenceCesiumWriter : CesiumPropertyWriter<HeightReferenceCesiumWriter>
    {
        ...
        /// <summary>
        /// Returns a wrapper for this instance that implements <see cref="ICesiumValuePropertyWriter{T}" /> to write a value in <code>HeightReference</code> format.  Because the returned instance is a wrapper for this instance, you may call <see cref="ICesiumElementWriter.Close" /> on either this instance or the wrapper, but you must not call it on both.
        /// </summary>
