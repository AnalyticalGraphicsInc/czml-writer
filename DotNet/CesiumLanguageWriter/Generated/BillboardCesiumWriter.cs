...
namespace CesiumLanguageWriter
{
    ...
    public class BillboardCesiumWriter : CesiumPropertyWriter<BillboardCesiumWriter>
    {
        ...
        /// <summary>
        /// Gets the writer for the <c>pixelOffset</c> property. The returned instance must be opened by calling the <see cref="CesiumElementWriter.Open"/> method before it can be used for writing. The <c>pixelOffset</c> property defines the offset, in viewport pixels, of the billboard origin from the <c>position</c>. A pixel offset is the number of pixels up and to the right to place the billboard, relative to the <c>position</c>. If not specified, the default value is [0.0, 0.0].
        /// </summary>
        [NotNull]
        ...
        /// <summary>
        /// Writes a value for the <c>pixelOffset</c> property as a <c>cartesian2</c> value. The <c>pixelOffset</c> property specifies the offset, in viewport pixels, of the billboard origin from the <c>position</c>. A pixel offset is the number of pixels up and to the right to place the billboard, relative to the <c>position</c>. If not specified, the default value is [0.0, 0.0].
        /// </summary>
        /// <param name="value">The value.</param>
        ...
        /// <summary>
        /// Gets the writer for the <c>eyeOffset</c> property. The returned instance must be opened by calling the <see cref="CesiumElementWriter.Open"/> method before it can be used for writing. The <c>eyeOffset</c> property defines the eye offset of the billboard, which is the offset in eye coordinates at which to place the billboard relative to the <c>position</c> property. Eye coordinates are a left-handed coordinate system where the X-axis points toward the viewer's right, the Y-axis points up, and the Z-axis points into the screen. If not specified, the default value is [0.0, 0.0, 0.0].
        /// </summary>
        [NotNull]
        ...
        /// <summary>
        /// Writes a value for the <c>eyeOffset</c> property as a <c>cartesian</c> value. The <c>eyeOffset</c> property specifies the eye offset of the billboard, which is the offset in eye coordinates at which to place the billboard relative to the <c>position</c> property. Eye coordinates are a left-handed coordinate system where the X-axis points toward the viewer's right, the Y-axis points up, and the Z-axis points into the screen. If not specified, the default value is [0.0, 0.0, 0.0].
        /// </summary>
        /// <param name="value">The value.</param>
        ...
        /// <summary>
        /// Opens and returns the writer for the <c>alignedAxis</c> property. The <c>alignedAxis</c> property defines the aligned axis is the unit vector, in world coordinates, that the billboard up vector points towards. The default is the zero vector, which means the billboard is aligned to the screen up vector. If not specified, the default value is [0.0, 0.0, 0.0].
        /// </summary>
        [NotNull]
        ...
        /// <summary>
        /// Writes a value for the <c>alignedAxis</c> property as a <c>unitCartesian</c> value. The <c>alignedAxis</c> property specifies the aligned axis is the unit vector, in world coordinates, that the billboard up vector points towards. The default is the zero vector, which means the billboard is aligned to the screen up vector. If not specified, the default value is [0.0, 0.0, 0.0].
        /// </summary>
        /// <param name="value">The value.</param>
        ...
        /// <summary>
        /// Writes a value for the <c>alignedAxis</c> property as a <c>unitSpherical</c> value. The <c>alignedAxis</c> property specifies the aligned axis is the unit vector, in world coordinates, that the billboard up vector points towards. The default is the zero vector, which means the billboard is aligned to the screen up vector. If not specified, the default value is [0.0, 0.0, 0.0].
        /// </summary>
        /// <param name="value">The value.</param>
        ...
        /// <summary>
        /// Writes a value for the <c>distanceDisplayCondition</c> property as a <c>distanceDisplayCondition</c> value. The <c>distanceDisplayCondition</c> property specifies the display condition specifying the distance from the camera at which this billboard will be displayed.
        /// </summary>
        /// <param name="value">The value.</param>
