...
namespace CesiumLanguageWriter
{
    ...
    public class CustomPropertiesCesiumWriter : CesiumPropertyWriter<CustomPropertiesCesiumWriter>
    {
        ...
        public CustomPropertiesCesiumWriter([NotNull] string propertyName)
            : base(propertyName)
        {
        }
        ...
        protected CustomPropertiesCesiumWriter([NotNull] CustomPropertiesCesiumWriter existingInstance)
