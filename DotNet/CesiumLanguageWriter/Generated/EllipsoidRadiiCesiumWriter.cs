...
{
    /// <summary>
    /// Writes a <c>EllipsoidRadii</c> to a <see cref="CesiumOutputStream" />.  A <c>EllipsoidRadii</c> is the radii of an ellipsoid.
    /// </summary>
    public class EllipsoidRadiiCesiumWriter : CesiumInterpolatablePropertyWriter<EllipsoidRadiiCesiumWriter>
    {
        ...
        /// <summary>
        /// Writes the value expressed as a <c>cartesian</c>, which is the radii specified as a three-dimensional Cartesian value <c>[X, Y, Z]</c>, in world coordinates in meters.
        /// </summary>
        ...
        /// <summary>
        /// Writes the value expressed as a <c>reference</c>, which is the radii specified as a reference to another property.
        /// </summary>
        ...
        {
            return new CesiumInterpolatableWriterAdaptor<EllipsoidRadiiCesiumWriter, Cartesian>(this, (me, value) => me.WriteCartesian(value), (me, dates, values, startIndex, length) => me.WriteCartesian(dates, values, startIndex, length));
        }
        ...
        {
            return new CesiumWriterAdaptor<EllipsoidRadiiCesiumWriter, Reference>(this, (me, value) => me.WriteReference(value));
        }
