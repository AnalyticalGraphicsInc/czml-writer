...
namespace CesiumLanguageWriter
{
    ...
    public class TranslateCesiumWriter : CesiumInterpolatablePropertyWriter<TranslateCesiumWriter>
    {
        ...
        {
            return new CesiumInterpolatableWriterAdaptor<TranslateCesiumWriter, Cartesian>(
                this, (me, value) => me.WriteCartesian(value), (TranslateCesiumWriter me, IList<JulianDate> dates, IList<Cartesian> values, int startIndex, int length) => me.WriteCartesian(dates, values, startIndex, length));
        }
        ...
        {
            return new CesiumWriterAdaptor<TranslateCesiumWriter, Reference>(
