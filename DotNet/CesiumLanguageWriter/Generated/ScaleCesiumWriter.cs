...
namespace CesiumLanguageWriter
{
    ...
    public class ScaleCesiumWriter : CesiumInterpolatablePropertyWriter<ScaleCesiumWriter>
    {
        ...
        /// <summary>
        /// Writes the <code>cartesian</code> property.  The <code>cartesian</code> property specifies the scaling factor specified as `[X, Y, Z]` factors in  meters.  If the array has three elements, the scaling is constant.  If it has four or more elements, they are time-tagged samples arranged as `[Time, X, Y, Z, Time, X, Y, Z, Time, X, Y, Z, ...]`, where _Time_ is an ISO 8601 date and time string or seconds since `epoch`.
        /// </summary>
        ...
        {
            return new CesiumInterpolatableWriterAdaptor<ScaleCesiumWriter, Cartesian>(
                this, (me, value) => me.WriteCartesian(value), (ScaleCesiumWriter me, IList<JulianDate> dates, IList<Cartesian> values, int startIndex, int length) => me.WriteCartesian(dates, values, startIndex, length));
        }
        ...
        {
            return new CesiumWriterAdaptor<ScaleCesiumWriter, Reference>(
