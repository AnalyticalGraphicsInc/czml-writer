...
{
    /// <summary>
    /// Writes a <code>Translation</code> to a <see cref="CesiumOutputStream" />.  A <code>Translation</code> is a translational offset which can optionally vary over time.
    /// </summary>
    public class TranslationCesiumWriter : CesiumInterpolatablePropertyWriter<TranslationCesiumWriter>
    {
        ...
        /// <summary>
        /// Writes the value expressed as a <code>cartesian</code>, which is the translation specified as a three-dimensional Cartesian value `[X, Y, Z]`, in meters.
        /// </summary>
        ...
        /// <summary>
        /// Writes the value expressed as a <code>reference</code>, which is the translation specified as a reference to another property.
        /// </summary>
