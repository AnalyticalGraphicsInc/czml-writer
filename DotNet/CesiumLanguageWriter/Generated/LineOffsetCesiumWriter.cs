...
{
    /// <summary>
    /// Writes a <code>LineOffset</code> to a <see cref="CesiumOutputStream" />.  A <code>LineOffset</code> is the offset of grid lines along each axis, as a percentage from 0 to 1.
    /// </summary>
    public class LineOffsetCesiumWriter : CesiumInterpolatablePropertyWriter<LineOffsetCesiumWriter>
    {
        ...
        /// <summary>
        /// Writes the value expressed as a <code>cartesian2</code>, which is the offset of grid lines along each axis, specified as a percentage from 0 to 1.
        /// </summary>
        ...
        /// <summary>
        /// Writes the value expressed as a <code>reference</code>, which is the offset of grid lines along each axis specified as a reference to another property.
        /// </summary>
