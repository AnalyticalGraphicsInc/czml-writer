...
namespace CesiumLanguageWriter
{
    ...
    public class PathCesiumWriter : CesiumPropertyWriter<PathCesiumWriter>
    {
        ...
        /// <summary>
        /// Opens and returns the writer for the <c>materialMode</c> property. The <c>materialMode</c> property defines whether the material applies to the whole path or portions of the path. If not specified, the default value is WHOLE.
        /// </summary>
        [NotNull]
        ...
        /// <summary>
        /// Writes a value for the <c>materialMode</c> property as a <c>pathMode</c> value. The <c>materialMode</c> property specifies whether the material applies to the whole path or portions of the path. If not specified, the default value is WHOLE.
        /// </summary>
        ...
        /// <summary>
        /// Writes a value for the <c>materialMode</c> property as a <c>reference</c> value. The <c>materialMode</c> property specifies whether the material applies to the whole path or portions of the path. If not specified, the default value is WHOLE.
        /// </summary>
        /// <param name="value">The reference.</param>
