...
{
    /// <summary>
    /// Writes a <code>ShadowMode</code> to a <see cref="CesiumOutputStream" />.  A <code>ShadowMode</code> is whether or not an object casts or receives shadows from each light source when shadows are enabled.
    /// </summary>
    public class ShadowModeCesiumWriter : CesiumPropertyWriter<ShadowModeCesiumWriter>
    {
        ...
        /// <summary>
        /// Returns a wrapper for this instance that implements <see cref="ICesiumValuePropertyWriter{T}" /> to write a value in <code>ShadowMode</code> format.  Because the returned instance is a wrapper for this instance, you may call <see cref="ICesiumElementWriter.Close" /> on either this instance or the wrapper, but you must not call it on both.
        /// </summary>
