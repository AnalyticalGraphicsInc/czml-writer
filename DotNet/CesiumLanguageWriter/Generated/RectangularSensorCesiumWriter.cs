...
namespace CesiumLanguageWriter
{
    ...
    public class RectangularSensorCesiumWriter : CesiumPropertyWriter<RectangularSensorCesiumWriter>
    {
        ...
        /// <summary>
        /// Gets the writer for the <c>xHalfAngle</c> property.  The returned instance must be opened by calling the <see cref="CesiumElementWriter.Open"/> method before it can be used for writing.  The <c>xHalfAngle</c> property defines the X half angle. If not specified, the default value is PI / 2.
        /// </summary>
        [NotNull]
        ...
        /// <summary>
        /// Opens and returns the writer for the <c>xHalfAngle</c> property.  The <c>xHalfAngle</c> property defines the X half angle. If not specified, the default value is PI / 2.
        /// </summary>
        [NotNull]
        ...
        /// <summary>
        /// Writes a value for the <c>xHalfAngle</c> property as a <c>number</c> value.  The <c>xHalfAngle</c> property specifies the X half angle. If not specified, the default value is PI / 2.
        /// </summary>
        /// <param name="value">The value.</param>
        ...
        /// <summary>
        /// Gets the writer for the <c>yHalfAngle</c> property.  The returned instance must be opened by calling the <see cref="CesiumElementWriter.Open"/> method before it can be used for writing.  The <c>yHalfAngle</c> property defines the Y half angle. If not specified, the default value is PI / 2.
        /// </summary>
        [NotNull]
        ...
        /// <summary>
        /// Opens and returns the writer for the <c>yHalfAngle</c> property.  The <c>yHalfAngle</c> property defines the Y half angle. If not specified, the default value is PI / 2.
        /// </summary>
        [NotNull]
        ...
        /// <summary>
        /// Writes a value for the <c>yHalfAngle</c> property as a <c>number</c> value.  The <c>yHalfAngle</c> property specifies the Y half angle. If not specified, the default value is PI / 2.
        /// </summary>
        /// <param name="value">The value.</param>
