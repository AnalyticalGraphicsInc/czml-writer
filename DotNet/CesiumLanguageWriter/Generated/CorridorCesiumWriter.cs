...
namespace CesiumLanguageWriter
{
    ...
    public class CorridorCesiumWriter : CesiumPropertyWriter<CorridorCesiumWriter>
    {
        ...
        /// <summary>
        /// Gets the writer for the <code>show</code> property.  The returned instance must be opened by calling the <see cref="CesiumElementWriter.Open"/> method before it can be used for writing.  The <code>show</code> property defines whether or not the corridor is shown.  If not specified, the default value is <see langword="true"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the writer for the <code>positions</code> property.  The returned instance must be opened by calling the <see cref="CesiumElementWriter.Open"/> method before it can be used for writing.  The <code>positions</code> property defines the array of positions defining the centerline of the corridor.
        /// </summary>
        ...
        /// <summary>
        /// Gets the writer for the <code>fill</code> property.  The returned instance must be opened by calling the <see cref="CesiumElementWriter.Open"/> method before it can be used for writing.  The <code>fill</code> property defines whether or not the corridor is filled.  If not specified, the default value is <see langword="true"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the writer for the <code>outline</code> property.  The returned instance must be opened by calling the <see cref="CesiumElementWriter.Open"/> method before it can be used for writing.  The <code>outline</code> property defines whether or not the corridor is outlined.  If not specified, the default value is <see langword="false"/>.
        /// </summary>
        ...
        /// <summary>
        /// Gets the writer for the <code>shadows</code> property.  The returned instance must be opened by calling the <see cref="CesiumElementWriter.Open"/> method before it can be used for writing.  The <code>shadows</code> property defines whether or not the corridor casts or receives shadows.  If not specified, the default value is DISABLED.
        /// </summary>
        ...
        /// <summary>
        /// Opens and returns the writer for the <code>shadows</code> property.  The <code>shadows</code> property defines whether or not the corridor casts or receives shadows.  If not specified, the default value is DISABLED.
        /// </summary>
        ...
        /// <summary>
        /// Writes a value for the <code>shadows</code> property as a <code>shadowMode</code> value.  The <code>shadows</code> property specifies whether or not the corridor casts or receives shadows.  If not specified, the default value is DISABLED.
        /// </summary>
        ...
        /// <summary>
        /// Writes a value for the <code>shadows</code> property as a <code>reference</code> value.  The <code>shadows</code> property specifies whether or not the corridor casts or receives shadows.  If not specified, the default value is DISABLED.
        /// </summary>
        /// <param name="value">The reference.</param>
