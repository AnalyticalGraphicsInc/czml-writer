...
namespace CesiumLanguageWriter
{
    ...
    public class PolylineCesiumWriter : CesiumPropertyWriter<PolylineCesiumWriter>
    {
        ...
        /// <summary>
        /// Gets the writer for the <code>shadows</code> property.  The returned instance must be opened by calling the <see cref="CesiumElementWriter.Open"/> method before it can be used for writing.  The <code>shadows</code> property defines whether or not the polyline casts or receives shadows.  If not specified, the default value is DISABLED.
        /// </summary>
        ...
        /// <summary>
        /// Opens and returns the writer for the <code>shadows</code> property.  The <code>shadows</code> property defines whether or not the polyline casts or receives shadows.  If not specified, the default value is DISABLED.
        /// </summary>
        ...
        /// <summary>
        /// Writes a value for the <code>shadows</code> property as a <code>shadowMode</code> value.  The <code>shadows</code> property specifies whether or not the polyline casts or receives shadows.  If not specified, the default value is DISABLED.
        /// </summary>
        ...
        /// <summary>
        /// Writes a value for the <code>shadows</code> property as a <code>reference</code> value.  The <code>shadows</code> property specifies whether or not the polyline casts or receives shadows.  If not specified, the default value is DISABLED.
        /// </summary>
        /// <param name="value">The reference.</param>
