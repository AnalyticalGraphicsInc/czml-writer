...
{
    /// <summary>
    /// A <see cref="CesiumPropertyWriter{T}"/> for writing properties related to the blob material to a
    /// <topic name="Cesium">Cesium</topic> stream.
    /// </summary>
    public class BlobMaterialCesiumWriter : CesiumPropertyWriter<BlobMaterialCesiumWriter>
    {
        ...
        public BlobMaterialCesiumWriter(string propertyName)
            : base(propertyName)
        {
        }

        /// <inheritdoc />
        private BlobMaterialCesiumWriter(BlobMaterialCesiumWriter existingInstance)
            : base(existingInstance)
        {
        }

        /// <inheritdoc />
        public override BlobMaterialCesiumWriter Clone()
        {
            return new BlobMaterialCesiumWriter(this);
        }
        ...
        /// <summary>
        /// Opens a property describing the dark color of the blob pattern.
        /// </summary>
        ...
        /// <summary>
        /// Opens a property describing the light color of the blob pattern.
        /// </summary>
        ...
        /// <summary>
        /// Opens a property describing the repeat of the blob pattern.
        /// </summary>
