...
#endif
{
    ...
    /// <summary>
    /// Adapts a class derived from <see cref="CesiumValuePropertyWriter{TValue,TDerived}"/> to implement
    ...
    /// </summary>
    /// <typeparam name="TFrom">The class derived from <see cref="CesiumValuePropertyWriter{TValue,TDerived}"/> to adapt.</typeparam>
